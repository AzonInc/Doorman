...
Doorman ist nicht auf TC:BUS oder In-Home-Bus Gegensprechanlagen beschränkt. 
...
Wenn deine Gegensprechanlage auf einem 2-Draht-Bus im Bereich von 14-30V DC arbeitet, könnte es möglich sein, auch andere Protokolle zu implementieren.

Alternativ kannst du den Spannungspegel auf älteren Gegensprechanlagen (14-30V DC) mithilfe des internen ADC überwachen und spezifische Aktionen basierend auf den Messwerten auslösen.
...
- WS2812B/SK6812B RGB LED zur Anzeige bestimmter Ereignisse
- Zwei zusätzliche GPIOs zur einfachen Erweiterung mit eigenen Sensoren und Geräten (z.B. I²C, Externer Button)
...
- SIEDLE:IN-HOME-BUS Kommunikation für Funktionen wie das Öffnen der Haustür und das Erkennen der Klingel
