...
StatusTrigger = status_indicator_ns.class_("StatusTrigger", auto.Trigger.template())
StatusAction = status_indicator_ns.class_("StatusAction", auto.Action)
CONF_TRIGGER_LIST = {
    "on_app_error": True,
    ...
    "on_improv_enabled": True,
    "on_improv_disabled": True,
    ...
    return auto.validate_automation(
        {
            ...
            cv.Optional(CONF_PRIORITY, default=0): cv.int_range(0, 9999),
        },
        single=Single,
    )
